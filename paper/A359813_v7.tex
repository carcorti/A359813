...
(see~\cite{Repo} for the representative validation logs).
...
the main campaign logs, and the full methodological documentation are available
...
\bibitem{Repo}
C.\ Corti,
\emph{oeis-A359813: Extension of OEIS sequence A359813 to $n = 17$ and
$n = 18$},
